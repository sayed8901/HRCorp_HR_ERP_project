...
const TransferModal = ({
  ...
  const handleSubmit = (e) => {
    ...
    onUpdateTransfer(transferData.employee, transferData.id, finalData);
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
      <div className="bg-white rounded-lg p-6 w-5/6 sm:w-2/3 max-w-md">
        <h2 className="text-xl mb-4 text-center">
          Update Transfer{" "}
          <span className="font-bold">Transfer_ID: {transferData?.id}</span>{" "}
          (ID#
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-4 flex justify-around gap-4">
            ...
            >
              {isProcessing ? <LoadingSpinner /> : "Confirm Transfer Update"}
            </button>
          </div>
        </form>
      </div>
