...
const TableForTransfer = ({ filteredEmployees, onTransferModalClick }) => {
              ...
              >
                ...
                <th className="border border-gray-300">
                  <button
                    ...
                    onClick={() => onTransferModalClick(employee)}
                  >
                    Transfer
                  </button>
                </th>
...
TableForTransfer.propTypes = {
  filteredEmployees: PropTypes.array.isRequired,
  onTransferModalClick: PropTypes.func.isRequired,
};

export default TableForTransfer;
