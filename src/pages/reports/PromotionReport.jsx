...
const PromotionReport = () => {
  ...
  // Helper function to filter employees by promotion date
  const filterByPromotionDate = (startDate, endDate) => {
    ...
    return allEmployeesFullInfo.filter((employee) => {
      ...
      // getting the number of employees promoted within the filtered duration
      return promotionDate >= start && promotionDate <= end;
    });
  };
    ...
    <div className="mt-16 mb-10 mx-10">
      <div className="sm:mx-auto">
        <h2 className="my-10 text-center text-2xl font-semibold leading-9 tracking-tight">
          You can get <span className="text-gradient">Promotion Report</span> by
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        <StatisticsCard
          title="Promoted (in Selected Duration) by Department"
        ...
        <StatisticsCard
          title="Promoted (in Selected Duration) by Designation"
        ...
        <StatisticsCard
          title="Promoted (in Selected Duration) by Job Location"
